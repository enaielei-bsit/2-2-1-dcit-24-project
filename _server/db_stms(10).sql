...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 15, 2019 at 11:45 PM
...
CREATE TABLE IF NOT EXISTS `tbl_task_entries` (
  ...
  `Answer Content` json NOT NULL,
  `Right Answers` int(11) NOT NULL,
  `Wrong Answers` int(11) NOT NULL,
...
INSERT INTO `tbl_task_entries` (`Task Entry ID`, `Task ID`, `Class Student ID`, `Answer Content`, `Right Answers`, `Wrong Answers`, `Time Remaining`, `Score`) VALUES
(1, 54, 8, 'null', 0, 0, NULL, 0),
(2, 55, 8, 'null', 0, 0, NULL, 0),
(3, 56, 9, 'null', 0, 0, NULL, 0),
(4, 54, 10, 'null', 0, 0, NULL, 0),
(5, 55, 10, 'null', 0, 0, NULL, 0);
